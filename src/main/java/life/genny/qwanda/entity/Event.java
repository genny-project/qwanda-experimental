...
public class Event extends BaseEntity implements Serializable, BaseEntityIntf {
	/**
	 * 
	 */
	 static final long serialVersionUID = 1L;

	 static final String DEFAULT_CODE_PREFIX = "EVT_";
	...
	/**
	  ...
	  */
	public Event(String aCode, String aName)
	{
