...
public class QEventTableSelectMessage extends QEventMessage {
	 ...
	 static final String EVENT_TYPE_BTN_CLICK = "TABLE_SELECT";

	public QEventTableSelectMessage(String btnCode) {
