...
public class Question extends CodedEntity implements Serializable {
	 ...
	 */
	 ...
	 static final String DEFAULT_CODE_PREFIX = "QUE_";
	...
	@JsonIgnore
	 Set<QuestionQuestion> childQuestions = new HashSet<QuestionQuestion>(0);
	 ...
	 */
	 void setAttributeCode(final String attributeCode) {
